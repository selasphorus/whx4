 ...
 */
add_filter( 'acf/settings/show_admin', 'whx3_show_acf_admin' );
/**
 * Filters the settings to pass to the block editor for all editor type.
 *
 * @link https://developer.wordpress.org/reference/hooks/block_editor_settings_all/
 */
add_filter( 'block_editor_settings_all', 'whx3_restrict_locking_ui', 10, 2 );
 ...
 * @since 0.1.3
 */
function whx3_restrict_locking_ui( $settings ) {
	$settings['canLockBlocks'] = whx3_show_acf_admin();
