    ...
    public static function register(): void
    {
        ...
        */
        ...
        acf_add_local_field_group([
            ...
            'fields' => [
                [
                    'key' => 'field_whx4_events_when_tab',
                    'label' => 'When',
                    'name' => '',
                    'aria-label' => '',
                    'type' => 'tab',
                ...
                [
                    'key'   => 'field_whx4_events_timezone',
                    'label' => 'Timezone',
                    'name'  => 'whx4_events_timezone',
                    'type'  => 'text',
                    'required' => 0,
                    'conditional_logic' => 0,
                    'wrapper' => [
                ...
                [
                    'key'   => 'field_whx4_events_timezone_txt',
                    'label' => 'Timezone (TXT)',
                    'name'  => 'whx4_events_timezone_txt',
                    'type'  => 'text',
                    'required' => 0,
                    'conditional_logic' => 0,
                    'wrapper' => [
