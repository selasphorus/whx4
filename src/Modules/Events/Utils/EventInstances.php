    ...
    public static function renderMetaBox( WP_Post $post ): void
    {
        ...
        foreach ( $instances as $date ) {
            ...
            if ( $replacement_id ) {
                ...
                echo '<span class="button disabled"><img src="/src/assets/graphics/excluded.png" alt="Excluded" style="height:1rem; vertical-align:middle;"></span>&nbsp;';
                ...
                echo '<span class="button disabled"><img src="/src/assets/graphics/exclude.png" alt="Excluded" style="height:1rem; vertical-align:middle;"></span>&nbsp;';
