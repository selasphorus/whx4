...
class GroupEntity extends Core\PostTypeHandler {

	public const SLUG = 'group';
	...
	*/
    ...
    public function getCPTLabels(): array {
        $labels = parent::getCPTLabels();
        $labels['name'] = 'Groups'; // override label
        return $labels;
    }
